            ...
            const handleActivity = {
                "page.useEffect.handleActivity": ()=>{
                    ...
                    brbTimeout.current = setTimeout({
                        "page.useEffect.handleActivity": ()=>setStatus("be right back")
                    }["page.useEffect.handleActivity"], 5 * 60 * 1000);
                    // After 15 minutes of inactivity, set to "ffline
                    activityTimeout.current = setTimeout({
                        "page.useEffect.handleActivity": ()=>setStatus("offline")
                    }["page.useEffect.handleActivity"], 15 * 60 * 1000);
                }
            }["page.useEffect.handleActivity"];
...
_s(page, "VmzeC1c3hFNiWESXi0t413dus5A=");
