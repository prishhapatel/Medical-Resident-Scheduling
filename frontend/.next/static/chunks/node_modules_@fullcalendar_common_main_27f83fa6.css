/* [project]/node_modules/@fullcalendar/common/main.css [app-client] (css) */
...
.fc .fc-non-business {
  background: #d7d7d74d;
  background: var(--fc-non-business-color, #d7d7d74d);
}
...
.fc .fc-highlight {
  background: #bce8f14d;
  background: var(--fc-highlight-color, #bce8f14d);
}

.fc .fc-cell-shaded, .fc .fc-day-disabled {
  background: #d0d0d04d;
  background: var(--fc-neutral-bg-color, #d0d0d04d);
}
...
.fc-event-selected:after, .fc-event:focus:after {
  content: "";
  background: #00000040;
  background: var(--fc-event-selected-overlay-color, #00000040);
  z-index: 1;
  position: absolute;
  inset: -1px;
}
...
/*# sourceMappingURL=node_modules_%40fullcalendar_common_main_27f83fa6.css.map*/